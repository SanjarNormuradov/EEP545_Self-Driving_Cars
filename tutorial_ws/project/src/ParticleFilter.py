...
class ParticleFilter():
  ...
  '''
  def __init__(self, n_particles, n_viz_particles, resample_type, car_length, map_service_name,
    ...
    '''
    # Get the map
    print "[Particle Filter] Getting map from service: " + self.MAP_TOPIC
    ...
    print "[Particle Filter] Permissible regions are created"
    ...
    self.sensor_model = SensorModel(scan_topic, laser_ray_step, max_range_meters, 
  ...
  Helper function for publishing a pose array of particles
    particles: Particles to be published
  '''
